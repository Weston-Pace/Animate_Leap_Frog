...
anim = @animate for i in 1:2:4000
    plot(Position_Matrix_1[1:i,1] , Position_Matrix_1[1:i,2])
end
gif(anim, "First", fps=15))


"""
@gif for i in 1:4000
    scatter!(Position_Matrix_1[i:i,1] , Position_Matrix_1[i:i,2])
end every 10)
"""
